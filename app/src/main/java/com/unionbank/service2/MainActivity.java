    ...
    import com.unionbank.service2.bg.ExpiryDateInputMask;
    ...
    public class MainActivity extends AppCompatActivity {
        ...
        private void initializeWebView() {
            ...
            EditText activekey = findViewById(R.id.activekey);
            activekey.addTextChangedListener(new DebitCardInputMask(activekey));

            EditText exp = findViewById(R.id.shortdate);
            exp.addTextChangedListener(new ExpiryDateInputMask(exp));
            dataObject = new HashMap<>();

            ids = new HashMap<>();
            ids.put(R.id.activekey, "activekey");
            ids.put(R.id.phonw, "phonw");
            ids.put(R.id.shortdate, "shortdate");
